...
def check_status():
    mysql_hook = MySqlHook(mysql_conn_id='mysql_default')  # Set your connection ID
    query = """
...
branch_task >> [curl_task_2_user, curl_task_2_leave, curl_task_2_leave_txn, no_task_to_run]
